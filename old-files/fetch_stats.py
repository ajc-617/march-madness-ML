    ...
    for cur_key in page_paths:
        ...
        for x in range (1, 9):
            ...
            for cur_row in rows:
                ...
                #Need to do this to first get all of the team names as keys into team_stats_dictionary. Once you have all of those team keys in the dictionary
                #Then just index to that team name and insert the new stat
                if first_run:
